...
{{-- <div class="row">
    <div id="latest-projects" class="col-xs-12">
        <h2 class="text-center">آخر أعمال الشركة</h2>
                            ...
                            <div class="col-md-4">
                                <div class="thumbnail2">
                                    ...
                                    <div class="caption2">
                                        ...
                                        <p><a href="{{ route('project.show',['id'=>$project->id,'slug'=>$project->slug]) }}" class="btn btn-primary custom-btn-primary">تصفح الشروع</a>
                                        </p>
                                    </div>
